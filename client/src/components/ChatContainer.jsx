...
const ChatContainer = ({selectedUser, setSelectedUser}) => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <img src={assets.help_icon} alt="" className='max-md:hidden max-w-5'/>
         ...
         {/*------Bottom area------*/}
          <div className='abosolute bottom- right-0 left-0 flex items-center gap-3 p-3'>
              <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
                <input type="text" placeholder='write a message' className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400 ' />
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>Select someone to start talking</p>
    </div>
  )
}
